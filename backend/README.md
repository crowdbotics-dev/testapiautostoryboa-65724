...
## Project Structure
    ...
    ├── testapiautostoryboa_65724  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_65724`
...
2. Clone this repo and `cd testapiautostoryboa_65724`
